...
/**
 * FacultyForm is a form class used for capturing faculty-related data.
 * This class extends {@link BaseForm} and contains fields for faculty details
 * with validation constraints.
 * 
 * <p>This form is used to collect and validate faculty information such as
 * personal details (name, DOB, gender, phone, email, qualification) and
 * associated college, course, and subject information before converting it
 * to a {@link FacultyDTO} object for database operations.</p>
 *
...
public class FacultyForm extends BaseForm {
    ...
    /** The phone number of the faculty member. Must be exactly 10 digits. */
    ...
    /** The ID of the college where the faculty member teaches. Must be at least 1. */
    ...
    /** The ID of the course taught by the faculty member. Must be at least 1. */
    ...
    /** The ID of the subject taught by the faculty member. Must be at least 1. */
    ...
    /**
     * Converts the form data to a {@link FacultyDTO} object.
